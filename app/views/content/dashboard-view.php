...
$total_proveedores = $insLogin->seleccionarDatos("Normal", "proveedores", "proveedor_id", 0);
?>
	...
	<div class="columns pt-6">
		<div class="column">
			<nav class="level is-mobile">
				...
				<div class="level-item has-text-centered">
					<a href="<?php echo APP_URL; ?>saleList/">
						<p class="heading"><i class="fas fa-industry fa-fw"></i> &nbsp; Proveedores</p>
						<p class="title"><?php echo $total_proveedores->rowCount(); ?></p>
					</a>
				</div>
			</nav>
		</div>

					...
					<div class="select">
						<select name="producto_proveedor">
							...
							while ($campos_proveedores = $datos_proveedores->fetch()) {
								if ($campos_proveedores['proveedor_id'] == $datos['proveedor_id']) {
									echo '<option value="' . $campos_proveedores['proveedor_id'] . '" selected="" >' . $cc . ' - ' . $campos_proveedores['proveedor_nombre'] . ' (Actual)</option>';
								} else {

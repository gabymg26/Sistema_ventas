<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar proveedores</h2>
</div>
...
<div class="container pb-6 pt-6">
    ...
    $insCategoria = new proveedorController();
    ...
    <?php
        echo $insCategoria->listarProveedorControlador($url[1], 15, $url[0], $_SESSION[$url[0]]);
    }
    ?>
</div>